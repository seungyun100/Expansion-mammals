...
#####################################################################
##### Estimates the range expansion process of Sika deer        #####
...
df_t1 <- "./data/animal/sikadeer/sikadeer_1978.shp"
df_t2 <- "./data/animal/sikadeer/sikadeer_2003_new.shp"
...
### Setting the path for SHP files and reading the data
df_t1 <- "./data/animal/sikadeer/sikadeer_2003.shp"
df_t2 <- "./data/animal/sikadeer/sikadeer_2014_new.shp"
grids <- st_read("./data/grid/mesh5.shp")
