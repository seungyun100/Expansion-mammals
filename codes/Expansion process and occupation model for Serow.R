...
#####################################################################
##### Estimates the range expansion process of Japanese serow   #####
...
df_t1 <- "./data/animal/serow/serow_1978.shp"
df_t2 <- "./data/animal/serow/serow_2003_new.shp"
...
### Setting the path for SHP files and reading the data
df_t1 <- "./data/animal/serow/serow_2003.shp"
df_t2 <- "./data/animal/serow/serow_2017_new.shp"
grids <- st_read("./data/grid/mesh5.shp")
